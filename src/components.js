...
Crafty.c('Goomba', {
  ...
  currentGridX : 0,
  currentGridY : 1,
  moveDir : Const.DIR_RIGHT,
  squealState : Const.SQUEAL_WALKING,
  msPerTile : 500,
  msPerSqueal : 500,
  nextGridX : 1,
  nextGridY : 1,
  ...
  leftTurn : [Const.DIR_UP, Const.DIR_LEFT, Const.DIR_DOWN, Const.DIR_RIGHT],
  rightTurn : [Const.DIR_DOWN, Const.DIR_RIGHT, Const.DIR_UP, Const.DIR_LEFT],
  reverseDir : [Const.DIR_LEFT, Const.DIR_DOWN, Const.DIR_RIGHT, Const.DIR_UP],
  ...
  enterFrame : function() {
    ...
    if(this.squealState != Const.SQUEAL_WALKING) {
      if(tweenDiff < this.msPerSqueal) {
        ...
        // squeal done
        this.squealState = Const.SQUEAL_WALKING;
  ...
  eatDeliciousAttractor : function(attractor) {
    ...
    if(this.currentGridX == at.x && this.currentGridY == at.y) {
      ...
      // happy squeal
      this.squealState = Const.SQUEAL_OMNOMNOM;
...
Crafty.c('BlueGoomba', {
  ...
  getNextDir : function() {
    ...
    if(this.getYummyTarget(attractors.bind(this))) {
      ...
      {
        // squeal with delight
        this.squealState = Const.SQUEAL_HAPPY;
